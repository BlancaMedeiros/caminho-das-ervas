...
### Página Inicial
![Vitrine de Produtos](./screenshots/banco-de-dados.png)

### Galeria de Produtos
![Vitrine de Produtos](./screenshots/produtos-loja.png)

### Galeria de Produtos
![Vitrine de Produtos](./screenshots/carrinho-cadastro-pagamento.png)

### Galeria de Produtos
![Home do Projeto](./screenshots/whatsapp-instagram.png)
...
- **Processamento:** O backend em Flask um microframework em Python que as lê a planilha utilizando a biblioteca `XLSX`, valida os campos e sincroniza os dados com um banco de dados **SQLite**.
...
### Back-end
- **Flask**: API REST para servir os dados ao front-end.
...
1. O administrador atualiza a planilha `produtos_loja.xlsx` a partir da pagina de adminstração. 
2. O servidor Flask realiza o `parse` dos dados.
3. O banco de dados `database.db` é limpo e repovoado com as informações atualizadas caso seja carregado pela pagiand e administração .
